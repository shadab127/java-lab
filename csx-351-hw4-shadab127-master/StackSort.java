...
public class StackSort {
    ...
    VectorStack <Integer> stack1 = new VectorStack(data.length);
    VectorStack <Integer> stack2 = new VectorStack(data.length);
    for(int newdata : data)
    {
    	if(stack2.isEmpty())
    	{
    		stack2.push( newdata );
